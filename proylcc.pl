...
buscar_y_combinar(GridEntrada, NumCols, PosInicio, GridSalida, Combinaciones) :-
    ...
    (   Len >= 2 ->
        findall(Val, (member(Pos, GrupoCombinable), nth0(Pos, GridEntrada, Val)), ValoresCombinables),
        sum_list(ValoresCombinables, NuevoValor),
...
buscar_todas_las_combinaciones(GridEntrada, NumCols, GridSalida, Combinaciones) :-
    ...
    findall(
        ...
        (   between(0, MaxIndex, Pos),
            ...
            Pos = MinPos,
            findall(Val, (member(P, GrupoCombinable), nth0(P, GridEntrada, Val)), ValoresGrupo),
            sum_list(ValoresGrupo, NuevoValor),
